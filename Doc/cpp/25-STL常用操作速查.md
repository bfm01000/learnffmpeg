...
> 底层原理与选型见 [[12-STL容器底层]]，算法与迭代器详见 [[19-STL算法与迭代器]]，智能指针见 [[06-智能指针与资源管理]]。
...
- [[12-STL容器底层]]：容器底层结构、扩容机制、迭代器失效、emplace vs push 的原理
- [[19-STL算法与迭代器]]：常用算法、erase-remove 惯用法、迭代器分类
- [[06-智能指针与资源管理]]：unique_ptr / shared_ptr 管理资源
- [[10-可调用对象-Lambda与std-function]]：Lambda 作为谓词传递给算法
- [[09-现代C++特性（C++11到17）]]：结构化绑定、CTAD 等特性在本篇大量使用
